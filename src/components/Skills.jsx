  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Next.js API Routes", level: 55 },
        { name: "RESTful APIs", level: 75 },
        { name: "CRUD Operations", level: 68 },
      ],
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "PayPal", level: 55 },
        { name: "Braintree Gateway", level: 55 },
        { name: "Cloudflare Image Storage", level: 50 },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="section-subtitle mx-auto">
            Technologies from my resume and real project experience
          </p>
        </motion.div>
