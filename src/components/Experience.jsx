  ...
  const experiences = [
    {
      ...
      company: "Pixsa Technologies - Remote",
      period: "Jan 2026 - Jun 2026",
      description:
        "Developed reusable frontend components, dashboards, and UI modules for an ERP system. Built responsive landing pages with optimized layouts, performance, and user experience. Integrated frontend modules with backend APIs and handled dynamic data, forms, and API error states.",
      type: "work",
      skills: [
        "React.js",
        "Next.js",
    ...
    },
    {
      ...
      company: "Infirix - Onsite",
      period: "Aug 2025 - Jan 2026",
      description:
        "Converted Figma UI/UX designs into pixel-perfect, responsive React components. Developed frontend features for an Inventory Management System using React.js and JavaScript. Implemented API integration, state management, reusable components, and form handling using Git/GitHub.",
      type: "work",
      skills: [
        "React.js",
        "JavaScript ES6+",
    ...
    },
    {
      ...
      period: "2022 - 2025",
      description:
        "Completed BS Computer Science with GPA 3.44/4. Final Year Project: eCampus Portal, a university management system with multiple modules and role-based dashboards.",
      type: "education",
    },
    {
      icon: Laptop,
      ...
      period: "2020",
      description:
        "Completed Diploma in Information Technology with 77.7%, covering computer fundamentals, office tools, web basics, and IT concepts.",
      type: "education",
    },
    {
      icon: Award,
      title: "Certifications",
      company: "Sukkur IBA / Udemy",
      period: "2023 - 2024",
      description:
        "Completed Web Development certification from Sukkur IBA University and The Complete JavaScript Course 2024 from Udemy. Continuously improving skills in React.js, Next.js, APIs, and modern web development.",
      type: "certification",
    },
  ];
